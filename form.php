...
<body>
    <div class="center">
        <form action="#" method="POST">
            <h1> Empyloee Entry Automation Software</h1>
            <div class="form">
                ...
                <input type="text" name="name" class="textfield" placeholder="Empyloee Name" value="<?php
                                                                                                    if (isset($_POST['searchdata'])) {
                ...
                <input type="text" name="email" class="textfield" placeholder="Email Address" value="<?php echo $result['emp_email']; ?>">
                ...
                <textarea name="address" placeholder="Address"><?php if (isset($_POST['searchdata'])) {
...
{
return  confirm('Are you sure you want to delete this rec record');
}
...
if (isset($_POST['save'])) {
    ...
    if ($data) {
        ...
        echo " <script> alert('Fail to  save data  into Database') </script>";
